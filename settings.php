            ...
            <div class="card-body tab-content">
              <div class="tab-pane active" id="profile">
				...
				<div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fullName" aria-describedby="fullNameHelp" placeholder="Entrez le titre de votre profil" value="">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="url" placeholder="Entrez votre numéro de téléphone" value="">
