...
$dsn = "mysql:host=localhost;dbname=udx"; // Remplacez 'nom_de_votre_base_de_donnees' par le nom réel de votre base
...
try {
    ...
    $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); // Affichage des erreurs PDO
